...
/**
 * convert_di - Converts an argt to a signed int and
 * stores it to a buffer contained in a struct.
 * @args: va_list pointing to the argt to be converted
...
/**
 * convert_b - Converts an unsigned int argt to binary
 ...
 * stores it to a buffer contained in a struct
 * @args: va_list poinitng to the argt to be converted
 * @flags: Flag modifiers
 * @wid: width modifier
 * @prec: precision modifier
 * @len: length modifier
...
/**
 * convert_u - Converts an unsigned int argt to decimal and
 * stores it to a buffer contained in a struct
 * @args: va_list pointing to the argt to be converted
 * @flags: Flag modifiers
 * @wid: width modifier
